...
var _user$project$Term$iconTerm = function (args) {
	return A2(_debois$elm_mdl$Material_Icon$view, 'list', args);
};
...
var _user$project$Topic$iconTopic = function (args) {
	return A2(_debois$elm_mdl$Material_Icon$view, 'subject', args);
};
...
var _user$project$Document$iconDoc = function (args) {
	return A2(_debois$elm_mdl$Material_Icon$view, 'description', args);
};
...
var _user$project$Slots$setAt = F3(
	function (slots, value, id) {
		return _elm_lang$core$Native_Utils.update(
			slots,
			{
				focus: A3(_elm_lang$core$Array$set, id, value, slots.focus)
			});
	});
var _user$project$Slots$rightHead = function (slots) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		slots.$null,
		_elm_lang$core$List$head(slots.right));
};
var _user$project$Slots$rightDrop = function (slots) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		_elm_lang$core$List$tail(slots.right));
};
var _user$project$Slots$leftHead = function (slots) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		slots.$null,
		_elm_lang$core$List$head(slots.left));
};
var _user$project$Slots$leftDrop = function (slots) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		_elm_lang$core$List$tail(slots.left));
};
var _user$project$Slots$getById = F2(
	function (slots, id) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			slots.$null,
			A2(_elm_lang$core$Array$get, id, slots.focus));
	});
var _user$project$Slots$getFocusLast = function (slots) {
	return A2(
		_user$project$Slots$getById,
		slots,
		_elm_lang$core$Array$length(slots.focus) - 1);
};
var _user$project$Slots$getFocusFirst = function (slots) {
	return A2(_user$project$Slots$getById, slots, 0);
};
var _user$project$Slots$getFirstIdOf = F2(
	function (slots, item) {
		var check = F2(
			function (value, counter) {
				return (_elm_lang$core$Native_Utils.eq(value, item) || counter.b) ? _elm_lang$core$Native_Utils.update(
					counter,
					{b: true}) : _elm_lang$core$Native_Utils.update(
					counter,
					{n: counter.n + 1});
			});
		var result = A3(
			...
			{n: 0, b: false},
			slots.focus);
		return result.b ? _elm_lang$core$Maybe$Just(result.n) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Slots$isNull = F2(
	function (slots, item) {
		return _elm_lang$core$Native_Utils.eq(item, slots.$null);
	});
var _user$project$Slots$isNotNull = F2(
	function (slots, item) {
		return !A2(_user$project$Slots$isNull, slots, item);
	});
var _user$project$Slots$getFocus = function (slots) {
	return A2(
		_elm_lang$core$Array$filter,
		_user$project$Slots$isNotNull(slots),
		slots.focus);
};
var _user$project$Slots$focusIsFull = function (slots) {
	return _elm_lang$core$Native_Utils.eq(
		_user$project$Slots$getFocus(slots),
		slots.focus);
};
var _user$project$Slots$getFocusFirstNotNull = function (slots) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		slots.$null,
		A2(
...
var _user$project$Slots$getFocusLastNotNull = function (slots) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		slots.$null,
		A2(
			...
			_elm_lang$core$Array$length(
				_user$project$Slots$getFocus(slots)) - 1,
			_user$project$Slots$getFocus(slots)));
};
var _user$project$Slots$leftAdd = F2(
	function (slots, item) {
		return A2(_user$project$Slots$isNull, slots, item) ? slots.left : {ctor: '::', _0: item, _1: slots.left};
	});
var _user$project$Slots$moveLeft = function (slots) {
	var next = F2(
		function (id, view) {
			return (_elm_lang$core$Native_Utils.cmp(
				id,
				_elm_lang$core$Array$length(slots.focus) - 1) < 0) ? A2(
				_elm_lang$core$Maybe$withDefault,
				slots.$null,
				A2(_elm_lang$core$Array$get, id + 1, slots.focus)) : _user$project$Slots$rightHead(slots);
		});
	return _elm_lang$core$Native_Utils.update(
		slots,
		{
			left: A2(
				_user$project$Slots$leftAdd,
				slots,
				_user$project$Slots$getFocusFirst(slots)),
			focus: A2(_elm_lang$core$Array$indexedMap, next, slots.focus),
			right: _user$project$Slots$rightDrop(slots)
		});
};
var _user$project$Slots$rightAdd = F2(
	function (slots, item) {
		return A2(_user$project$Slots$isNull, slots, item) ? slots.right : {ctor: '::', _0: item, _1: slots.right};
	});
var _user$project$Slots$moveRight = function (slots) {
	var next = F2(
		function (id, view) {
			return (_elm_lang$core$Native_Utils.cmp(id, 0) > 0) ? A2(
				_elm_lang$core$Maybe$withDefault,
				slots.$null,
				A2(_elm_lang$core$Array$get, id - 1, slots.focus)) : _user$project$Slots$leftHead(slots);
		});
	return _elm_lang$core$Native_Utils.update(
		slots,
		{
			left: _user$project$Slots$leftDrop(slots),
			focus: A2(_elm_lang$core$Array$indexedMap, next, slots.focus),
			right: A2(
				_user$project$Slots$rightAdd,
				slots,
				_user$project$Slots$getFocusLast(slots))
		});
};
var _user$project$Slots$insertAt = F3(
	function (slots, value, id) {
		var next = F3(
			function (useId, pointer, view) {
				return (_elm_lang$core$Native_Utils.cmp(pointer, useId) < 0) ? A2(
					_elm_lang$core$Maybe$withDefault,
					slots.$null,
					A2(_elm_lang$core$Array$get, pointer, slots.focus)) : (_elm_lang$core$Native_Utils.eq(pointer, useId) ? value : A2(
					_elm_lang$core$Maybe$withDefault,
					slots.$null,
					A2(_elm_lang$core$Array$get, pointer - 1, slots.focus)));
			});
		var calcPosition = function () {
			var _p0 = A2(_user$project$Slots$getFirstIdOf, slots, slots.$null);
			if (_p0.ctor === 'Just') {
				var _p1 = _p0._0;
				return (_elm_lang$core$Native_Utils.cmp(id, _p1) > 0) ? _p1 : id;
			} else {
				return id;
			}
		}();
		return A2(_user$project$Slots$isNull, slots, value) ? slots : (_user$project$Slots$focusIsFull(slots) ? _elm_lang$core$Native_Utils.update(
			slots,
			{
				focus: A2(
					_elm_lang$core$Array$indexedMap,
...
var _user$project$Slots$insertAfter = F3(
	function (slots, value, id) {
		return (_user$project$Slots$focusIsFull(slots) && _elm_lang$core$Native_Utils.eq(
			id + 1,
			_elm_lang$core$Array$length(slots.focus))) ? A3(
			_user$project$Slots$insertAt,
			_user$project$Slots$moveLeft(slots),
			value,
			id) : A3(_user$project$Slots$insertAt, slots, value, id + 1);
	});
var _user$project$Slots$focusLength = function (slots) {
	var count = F2(
		function (item, counter) {
			return A2(_user$project$Slots$isNull, slots, item) ? counter : (counter + 1);
		});
	return A3(_elm_lang$core$Array$foldl, count, 0, slots.focus);
};
var _user$project$Slots$insertEnd = F2(
	function (slots, value) {
		insertEnd:
		while (true) {
			if ((!_elm_lang$core$List$isEmpty(slots.right)) && _user$project$Slots$focusIsFull(slots)) {
				var _v1 = _user$project$Slots$moveLeft(slots),
					_v2 = value;
				slots = _v1;
				value = _v2;
				continue insertEnd;
				...
				return A3(
					...
					slots,
					value,
					_user$project$Slots$focusLength(slots) - 1);
			}
		}
	});
var _user$project$Slots$removeAt = F2(
	function (slots, id) {
		var alignLeft = function (slots) {
			alignLeft:
			while (true) {
				if (_user$project$Slots$focusIsFull(slots)) {
					return slots;
				} else {
					if (_elm_lang$core$List$isEmpty(slots.left)) {
						return slots;
					} else {
						var _v3 = _user$project$Slots$moveRight(slots);
						slots = _v3;
						continue alignLeft;
					}
				}
		...
		var next = F2(
			function (pointer, view) {
				return (_elm_lang$core$Native_Utils.cmp(pointer, id) < 0) ? A2(
					_elm_lang$core$Maybe$withDefault,
					slots.$null,
					A2(_elm_lang$core$Array$get, pointer, slots.focus)) : ((_elm_lang$core$Native_Utils.cmp(
					pointer,
					_user$project$Slots$focusLength(slots) - 1) < 0) ? A2(
					_elm_lang$core$Maybe$withDefault,
					slots.$null,
					A2(_elm_lang$core$Array$get, pointer + 1, slots.focus)) : _user$project$Slots$rightHead(slots));
			});
		var newSlots = _elm_lang$core$Native_Utils.update(
			slots,
			{
				focus: A2(_elm_lang$core$Array$indexedMap, next, slots.focus),
				right: _user$project$Slots$rightDrop(slots)
			});
		return alignLeft(newSlots);
	});
var _user$project$Slots$setFocusSize = F2(
	function (slots, focusSize) {
		var currentFocus = _elm_lang$core$Array$length(
			_user$project$Slots$getFocus(slots));
		var newFocus = _elm_lang$core$Native_Utils.eq(currentFocus, focusSize) ? _user$project$Slots$getFocus(slots) : ((_elm_lang$core$Native_Utils.cmp(currentFocus, focusSize) > 0) ? A3(
			_elm_lang$core$Array$slice,
			0,
			focusSize,
			_user$project$Slots$getFocus(slots)) : A2(
			...
			_elm_lang$core$Array$fromList(
				A2(
					...
					(_elm_lang$core$Native_Utils.cmp(
						_elm_lang$core$List$length(slots.right),
						focusSize - currentFocus) > -1) ? slots.right : A2(
						_elm_lang$core$List$append,
						slots.right,
						A2(_elm_lang$core$List$repeat, focusSize - currentFocus, slots.$null))))));
		var newRight = _elm_lang$core$Native_Utils.eq(currentFocus, focusSize) ? slots.right : ((_elm_lang$core$Native_Utils.cmp(currentFocus, focusSize) < 0) ? A2(_elm_lang$core$List$drop, focusSize - currentFocus, slots.right) : A2(
			_elm_lang$core$List$append,
			_elm_lang$core$Array$toList(
				A3(
					_elm_lang$core$Array$slice,
		...
		return _elm_lang$core$Native_Utils.update(
			slots,
			{focus: newFocus, right: newRight});
	});
var _user$project$Slots$Slots = F4(
	function (a, b, c, d) {
		return {left: a, focus: b, right: c, $null: d};
	});
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {topics: a, currentTopics: b, docs: c, currentDocument: d, terms: e, currentTerm: f, tabs: g, currentTab: h, raised: i, selectedMsg: j, settings: k, slots: l, containerTopicModel: m, topicsContainer: n, mdl: o};
														};
													};
												};
											};
...
var _user$project$Model$MoveRight = {ctor: 'MoveRight'};
var _user$project$Model$MoveLeft = {ctor: 'MoveLeft'};
var _user$project$Model$RemoveSlot = function (a) {
	return {ctor: 'RemoveSlot', _0: a};
};
var _user$project$Model$DeleteSlot = function (a) {
...
var _user$project$Model$AdvancedSearch = function (a) {
	return {ctor: 'AdvancedSearch', _0: a};
};
var _user$project$Model$Search = function (a) {
	return {ctor: 'Search', _0: a};
};
var _user$project$Model$Mobile = function (a) {
	return {ctor: 'Mobile', _0: a};
};
...
var _user$project$Request$loadBestDocs = F4(
	function (topic, maybeterm, sorting, slotId) {
		var name = function () {
			var _p0 = maybeterm;
			if (_p0.ctor === 'Just') {
		...
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Native_Utils.eq(slotId, model.settings.slotToDelete) ? _debois$elm_mdl$Material_Options$cs('slot__remove') : flex,
						_1: {
							ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Document$iconDoc(
							{
								ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _debois$elm_mdl$Material_Options$onClick(
																_user$project$Model$DeleteSlot(slotId)),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _user$project$Init$init = {
	...
	_0: {
		...
		slots: {
			...
			right: {ctor: '[]'},
			$null: _user$project$Model$Empty
		},
						...
						_1: {
							...
							_0: A2(
								_debois$elm_mdl$Material_Options$span,
								{
									...
									_0: _debois$elm_mdl$Material_Options$onClick(
										_user$project$Model$ExecCmd(
											A3(_user$project$Request$loadTerms, topic, 0, slotId))),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$center,
										_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A2(
									_debois$elm_mdl$Material_Options$span,
									{
										...
										_0: _debois$elm_mdl$Material_Options$onClick(
											_user$project$Model$ExecCmd(
												A4(_user$project$Request$loadBestDocs, topic, _elm_lang$core$Maybe$Nothing, 'RELEVANCE', slotId))),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$center,
											_1: {ctor: '[]'}
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Topic$iconTopic(
							{
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'margin', '5px'),
								_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								_debois$elm_mdl$Material_Options$span,
								{
									...
									_0: _debois$elm_mdl$Material_Options$onClick(
										_user$project$Model$ExecCmd(
											A3(_user$project$Request$loadTerms, topic, 30, 2))),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_debois$elm_mdl$Material_Options$span,
									{
										...
										_0: _debois$elm_mdl$Material_Options$onClick(
											_user$project$Model$ExecCmd(
												A4(_user$project$Request$loadBestDocs, topic, _elm_lang$core$Maybe$Nothing, 'relevance', 2))),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								A2(_elm_lang$core$List$indexedMap, _user$project$Savedview$slotView2Chip, model.slots.left)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									A2(_elm_lang$core$List$indexedMap, _user$project$Savedview$slotView2Chip, model.slots.right)),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Mainview_v2$flexValue = function (flex) {
	...
	switch (_p0) {
		case 6:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '6 5 50%');
		case 5:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '5 4 47%');
		case 4:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '4 3 32%');
		case 3:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '3 2 25%');
		case 2:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '2 2 12%');
		case 1:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '1 1 7%');
		case 0:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '0 0 0%');
		default:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '1 1 100%');
	}
};
var _user$project$Mainview_v2$viewOrEmptyFlex = F2(
	function (condition, view) {
		return condition ? view : A2(
			...
			{
				ctor: '::',
				_0: _user$project$Mainview_v2$flexValue(0),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'});
	});
						...
						_1: {
							...
							_0: A2(
								_debois$elm_mdl$Material_Options$div,
								{
									...
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-top', '40px'),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$cs('slot__content'),
											_1: {
...
var _user$project$Mainview_v2$viewBody = function (model) {
	return (!model.settings.mobile) ? A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Elevation$e4,
				...
				_elm_lang$core$List$concat(
					{
						...
						_0: {
							ctor: '::',
							_0: (!_elm_lang$core$List$isEmpty(model.slots.left)) ? A2(
								_user$project$Mainview_v2$slotAction,
								_debois$elm_mdl$Material_Options$onClick(_user$project$Model$MoveRight),
								'navigate_before') : A2(
								_debois$elm_mdl$Material_Options$div,
								{
									ctor: '::',
						...
						_1: {
							...
							_0: _elm_lang$core$Array$toList(
								A2(
									...
									_user$project$Slots$getFocus(model.slots))),
							_1: {
								ctor: '::',
								_0: {
									ctor: '::',
									_0: (_elm_lang$core$Native_Utils.cmp(
										_user$project$Slots$focusLength(model.slots),
										2) < 1) ? A2(
										_user$project$Mainview_v2$slotAction,
										_debois$elm_mdl$Material_Options$onClick(
											_user$project$Model$ChoseSlotDialog(
												_user$project$Slots$focusLength(model.slots))),
										'add') : ((!_elm_lang$core$List$isEmpty(model.slots.right)) ? A2(
										_user$project$Mainview_v2$slotAction,
										_debois$elm_mdl$Material_Options$onClick(_user$project$Model$MoveLeft),
										'navigate_next') : A2(
										_debois$elm_mdl$Material_Options$div,
										{
											ctor: '::',
		...
		}) : (model.settings.docview ? A2(
		_user$project$Tabsview$view,
		model,
		_user$project$Mainview_v2$flexValue(1)) : A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$cs('flex__row'),
		...
		_elm_lang$core$List$concat(
			{
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '::',
							_0: (!_elm_lang$core$List$isEmpty(model.slots.right)) ? A2(
								_user$project$Mainview_v2$slotAction,
								_debois$elm_mdl$Material_Options$onClick(_user$project$Model$MoveLeft),
								'navigate_next') : ((_elm_lang$core$Native_Utils.cmp(
								_user$project$Slots$focusLength(model.slots),
								2) < 1) ? A2(
								_user$project$Mainview_v2$slotAction,
								_debois$elm_mdl$Material_Options$onClick(
			...
			_1: {
				...
				_1: {
					...
					_0: A5(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('main view 2'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A5(
									...
									_1: {
										...
										_0: _debois$elm_mdl$Material_Options$onToggle(
											_user$project$Model$Toggle(
												_elm_lang$core$Native_Utils.update(
													oldSettings,
													{showRelevance: !model.settings.showRelevance}))),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Toggles$value(model.settings.showRelevance),
											_1: {ctor: '[]'}
										}
									}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('show term relevance'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A5(
									...
									model.mdl,
									{
										...
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$onToggle(
												_user$project$Model$Mobile(!model.settings.mobile)),
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Toggles$value(model.settings.mobile),
												_1: {ctor: '[]'}
											}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('mobile version'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A5(
											...
											_1: {
												...
												_0: _debois$elm_mdl$Material_Options$onToggle(
													_user$project$Model$Toggle(
														_elm_lang$core$Native_Utils.update(
															oldSettings,
															{docview: !model.settings.docview}))),
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Toggles$value(model.settings.docview),
													_1: {ctor: '[]'}
												}
											}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('show Document'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Mainview_v2$onEnterPressed = function (msg) {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Mainview_v2$onEnterPressed(
										_user$project$Model$AdvancedSearch(model.settings.search4)),
									_1: {
										ctor: '::',
...
var _user$project$Mainview_v3$flexValue = function (flex) {
	var _p0 = flex;
	switch (_p0) {
		case 6:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '6 5 50%');
...
var _user$project$Mainview_v3$viewOrEmptyFlex = F2(
	function (condition, view) {
		return condition ? view : A2(
			_debois$elm_mdl$Material_Options$div,
			{
				ctor: '::',
				_0: _user$project$Mainview_v3$flexValue(0),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'});
	});
var _user$project$Mainview_v3$slotDialogCard = F3(
	function (title, view, slotId) {
		return A2(
			_debois$elm_mdl$Material_Card$view,
			{
...
var _user$project$Mainview_v3$hiddenSlot = function (id) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
...
var _user$project$Mainview_v3$slot = F3(
	function (model, slotId, view) {
		var _p1 = view;
		switch (_p1.ctor) {
			case 'TopicsView':
...
var _user$project$Mainview_v3$slotAction = F2(
	function (action, icon) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
...
var _user$project$Mainview_v3$viewBody = function (model) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
				...
				_elm_lang$core$List$concat(
					{
						...
						_0: {
							ctor: '::',
							_0: (!_elm_lang$core$List$isEmpty(model.slots.left)) ? A2(
								_user$project$Mainview_v3$slotAction,
								_debois$elm_mdl$Material_Options$onClick(_user$project$Model$MoveRight),
								'<') : A2(
								_debois$elm_mdl$Material_Options$div,
								{ctor: '[]'},
						...
						_1: {
							...
							_0: _elm_lang$core$Array$toList(
								A2(
									_elm_lang$core$Array$indexedMap,
									_user$project$Mainview_v3$slot(model),
									_user$project$Slots$getFocus(model.slots))),
							_1: {
								ctor: '::',
								_0: {
									...
									_1: {
										...
										_0: A2(
											_user$project$Tabsview$view,
											model,
											_user$project$Mainview_v3$flexValue(6)),
										_1: {ctor: '[]'}
									}
								},
								_1: {ctor: '[]'}
...
var _user$project$Mainview_v3$viewSwitch = function (model) {
	var oldSettings = model.settings;
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{ctor: '[]'},
										...
										_1: {
											...
											_0: _debois$elm_mdl$Material_Options$onToggle(
												_user$project$Model$Toggle(
													_elm_lang$core$Native_Utils.update(
														oldSettings,
														{showRelevance: !model.settings.mobile}))),
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Toggles$value(model.settings.showRelevance),
												_1: {ctor: '[]'}
...
var _user$project$Mainview_v3$onEnterPressed = function (msg) {
	var isEnter = function (code) {
		return _elm_lang$core$Native_Utils.eq(code, 13) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('not ENTER');
	};
	return A2(
...
var _user$project$Mainview_v3$viewSearch = function (model) {
	return A2(
		_debois$elm_mdl$Material_Options$span,
		{
			ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Mainview_v3$onEnterPressed(
										_user$project$Model$AdvancedSearch(model.settings.search4)),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$dispatch(_user$project$Model$Batch),
...
var _user$project$Mainview_v3$view = function (model) {
	return A3(
		_debois$elm_mdl$Material_Scheme$topWithScheme,
		_debois$elm_mdl$Material_Color$Green,
		_debois$elm_mdl$Material_Color$Orange,
		A4(
			...
			},
			{
				...
				drawer: {
					ctor: '::',
					_0: _user$project$Mainview_v3$viewSwitch(model),
					_1: {ctor: '[]'}
				},
				tabs: {
					ctor: '_Tuple2',
				...
				main: {
					ctor: '::',
					_0: _user$project$Mainview_v3$viewBody(model),
					_1: {ctor: '[]'}
				}
			}));
};

var _user$project$Mainview_v4$flexValue = function (flex) {
	var _p0 = flex;
	switch (_p0) {
		case 6:
			return A2(_debois$elm_mdl$Material_Options$css, 'flex', '6 5 50%');
...
var _user$project$Mainview_v4$viewOrEmptyFlex = F2(
	function (condition, view) {
		return condition ? view : A2(
			_debois$elm_mdl$Material_Options$div,
			{
				ctor: '::',
				_0: _user$project$Mainview_v4$flexValue(0),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'});
	});
var _user$project$Mainview_v4$slotDialogCard = F3(
	function (title, view, slotId) {
		return A2(
			_debois$elm_mdl$Material_Card$view,
			{
...
var _user$project$Mainview_v4$hiddenSlot = function (id) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: A3(
										_user$project$Mainview_v4$slotDialogCard,
										'Topics',
										A4(_user$project$Model$TopicsView, 'Topics', model.topics, model.topicsContainer, _user$project$Model$Noparent),
										slotId),
									_1: {
...
var _user$project$Mainview_v4$slotAction = F2(
	function (action, icon) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
...
var _user$project$Mainview_v4$viewBody = function (model) {
	return (!model.settings.mobile) ? A2(
		...
		},
		{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Mainview_v4$flexValue(6),
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'height', '100%'),
										_1: {ctor: '[]'}
			...
			_1: {
				ctor: '::',
				_0: model.settings.docview ? A2(
					_user$project$Tabsview$view,
					model,
					_user$project$Mainview_v4$flexValue(6)) : A2(
					_debois$elm_mdl$Material_Options$div,
					{ctor: '[]'},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
		...
		_user$project$Tabsview$view,
		model,
		_user$project$Mainview_v4$flexValue(1)) : A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$cs('flex__row'),
		...
		_elm_lang$core$List$concat(
			{
				...
				_0: {
					ctor: '::',
					_0: (!_elm_lang$core$List$isEmpty(model.slots.left)) ? A2(
						_user$project$Mainview_v4$slotAction,
						_debois$elm_mdl$Material_Options$onClick(_user$project$Model$MoveRight),
						'navigate_before') : A2(
						_debois$elm_mdl$Material_Options$div,
						{
					...
					_0: model.settings.search ? A2(
						...
						},
						{
							...
							_0: A2(
								_user$project$Searchview$view,
								model,
								_user$project$Mainview_v4$flexValue(-1)),
							_1: {ctor: '[]'}
						}) : A2(
						_debois$elm_mdl$Material_Options$span,
						{ctor: '[]'},
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p0.ctor) {
				case 'Mobile':
					var _p1 = _p0._0;
					var newSlots = _p1 ? A2(_user$project$Slots$setFocusSize, model.slots, 1) : A2(_user$project$Slots$setFocusSize, model.slots, 3);
					var oldSettings = model.settings;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
								...
								if (A2(_elm_lang$core$String$startsWith, 'term:', searchterm)) {
									...
									if (A2(_elm_lang$core$String$startsWith, 'document:', searchterm)) {
										...
										if (_p3.ctor === 'Ok') {
											...
											return _user$project$Request$loadDoc(
												_elm_lang$core$Native_Utils.update(
													doc,
													{id: _p3._0}));
										} else {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								slots: A2(_user$project$Slots$insertEnd, model.slots, _p0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'DeleteSlot':
					...
					return {
						...
						_1: A3(
							...
							_user$project$Model$RemoveSlot(_p4))
					};
				case 'RemoveSlot':
					var oldSettings = model.settings;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								settings: _elm_lang$core$Native_Utils.update(
									oldSettings,
									{slotToDelete: -1}),
								slots: A2(_user$project$Slots$removeAt, model.slots, _p0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'MoveLeft':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								slots: _user$project$Slots$moveLeft(model.slots)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'MoveRight':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								slots: _user$project$Slots$moveRight(model.slots)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								slots: A2(_user$project$Slots$insertEnd, model.slots, _user$project$Model$Dialog)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'UpdateSlot':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								slots: A3(_user$project$Slots$setAt, model.slots, _p0._0, _p0._1)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'NewTopics':
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									tabs: A2(
										...
										{
											ctor: '::',
											_0: A2(_user$project$Model$DocumentTab, _p13.title, _p13),
											_1: {ctor: '[]'}
										}),
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									settings: _elm_lang$core$Native_Utils.update(
										oldSettings,
										{
											searchResult: _user$project$Model$TermResult(_p18._0),
											error: ''
										})
								}),
							_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$TE_elm_v1$view = function (model) {
	return model.settings.view2 ? _user$project$Mainview_v2$view(model) : _user$project$Mainview_v4$view(model);
};
var _user$project$TE_elm_v1$main = _elm_lang$html$Html$program(
	{init: _user$project$Init$init, update: _user$project$Update$update, view: _user$project$TE_elm_v1$view, subscriptions: _user$project$TE_elm_v1$subscriptions})();
...
Elm['Mainview_v3'] = Elm['Mainview_v3'] || {};
if (typeof _user$project$Mainview_v3$main !== 'undefined') {
    _user$project$Mainview_v3$main(Elm['Mainview_v3'], 'Mainview_v3', {"types":null,"versions":{"elm":"0.18.0"}});
}
...
Elm['Slots'] = Elm['Slots'] || {};
if (typeof _user$project$Slots$main !== 'undefined') {
    _user$project$Slots$main(Elm['Slots'], 'Slots', {"types":null,"versions":{"elm":"0.18.0"}});
}
