...
var _user$project$Slots$insertAfter = F3(
	function (slots, value, id) {
		return _user$project$Slots$focusIsFull(slots) ? A3(
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {error: a, showSaved: b, bottom: c, view2: d, showRelevance: e, showSlotDialoge: f, search: g, search4: h, searchResult: i, slotToDelete: j, selectedItem: k};
										};
									};
								};
							};
		...
		while (true) {
			...
			switch (_p0.ctor) {
				...
				case 'Search':
					var _p1 = _p0._0;
					var oldSettings = model.settings;
					return (!_elm_lang$core$Native_Utils.eq(_p1, '')) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
						...
						_1: _user$project$Request$loadSearchTerms(_p1)
					} : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				case 'AdvancedSearch':
				...
				case 'DeleteSlot':
					...
					return {
						...
						_1: A3(
							...
							_user$project$Model$RemoveSlot(_p3))
					};
				case 'RemoveSlot':
					var oldSettings = model.settings;
					return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									slots: A3(
										_user$project$Slots$insertAfter,
										model.slots,
										A3(_user$project$Model$TopicsView, _p0._0, _p5, topicsContainer),
										_p0._1),
									topics: _p5,
									settings: _elm_lang$core$Native_Utils.update(
										oldSettings,
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									slots: A3(
										_user$project$Slots$insertAfter,
										model.slots,
										A2(_user$project$Model$TermsView, _p0._0, _p7),
										_p0._1),
									terms: _p7,
									settings: _elm_lang$core$Native_Utils.update(
										oldSettings,
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									slots: A3(
										_user$project$Slots$insertAfter,
										model.slots,
										A2(_user$project$Model$DocumentsView, _p0._0, _p9),
										_p0._1),
									docs: _p9,
									settings: _elm_lang$core$Native_Utils.update(
										oldSettings,
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									tabs: A2(
										...
										{
											ctor: '::',
											_0: A2(_user$project$Model$DocumentTab, _p12.title, _p12),
											_1: {ctor: '[]'}
										}),
					...
					var fetchTerm = function (terms) {
						return _elm_lang$core$List$head(
							A2(
								_elm_lang$core$List$filter,
								function (x) {
									return _elm_lang$core$Native_Utils.eq(x.name, _p15);
								},
								terms));
					};
					var isMember = F2(
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									slots: A3(
										...
										A3(
											_user$project$Model$TopicsView,
											A2(_elm_lang$core$Basics_ops['++'], 'Topics with ', _p15),
											newTopics(_p14._0),
											topicsContainer),
										_p0._1),
									settings: _elm_lang$core$Native_Utils.update(
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									settings: _elm_lang$core$Native_Utils.update(
										oldSettings,
										{
											searchResult: _user$project$Model$TermResult(_p17._0),
											error: ''
										})
								}),
							_1: _elm_lang$core$Platform_Cmd$none
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									slots: A2(
										_user$project$Slots$insertEnd,
										model.slots,
										A2(_user$project$Model$DocumentsView, _p0._0, _p18._0)),
									settings: _elm_lang$core$Native_Utils.update(
										oldSettings,
										{search: false, error: ''})
								}),
				...
				case 'ContainerCacheTopicMsg':
					...
					var _p20 = A2(_user$project$ContainerCache$update, _p25, model.containerTopicModel);
					var newdata = _p20._0;
					var cmd = _p20._1;
					var newSlots = function () {
						...
						switch (_p21.ctor) {
							...
							case 'PageUpdate':
								var index = function () {
									var _p22 = A2(_user$project$Slots$getById, model.slots, _p24);
								...
								var newView = A3(
									...
									topicList(newContainer),
									index);
								return A3(_user$project$Slots$setAt, model.slots, newView, _p24);
							default:
								var index = function () {
									var _p23 = A2(_user$project$Slots$getById, model.slots, _p24);
					...
					return {
						...
						_1: A2(
							_elm_lang$core$Platform_Cmd$map,
							_user$project$Model$ContainerCacheTopicMsg(_p24),
							cmd)
					};
				case 'Batch':
					return A2(
