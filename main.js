...
var _user$project$Model$NewTermTopics = F2(
	function (a, b) {
...
var _user$project$Request$loadBestTerms = A3(
	...
	_user$project$Model$NewTerms('Terms'),
	'getBestTerms');
var _user$project$Request$loadAutocompleteTerms = function (termName) {
