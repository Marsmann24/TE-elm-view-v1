module ContainerCache exposing (ContainerModel, Container, Meta, Page(Loaded, ToLoad, HandleError), ContainerModelMsg(CreateNewContainer, PageUpdate), Msg(LoadNewContainer, LoadCheckPage), PageMsg(NextPage, PrevPage), defaultContainer, newContainerModel, update)
